...
public class UserDetailsDAOImpl implements UserDetailsDAO {
	...
	/*
	 * public boolean insert() throws SQLException { String sql = """ INSERT INTO
	 * user_details ( user_id, gender, dob, aadhaar_masked, pan_masked, country,
	 * state, district, city, pincode, primary_account_id ) VALUES ( 1, -- existing
	 * user_id 'male', '1995-04-25', 'XXXX-XXXX-1234', 'XXXXX1234X', 'India',
	 * 'Maharashtra', 'Pune', 'Pune', '411001', 5 -- existing account_id );
	 * 
	 * """; try (Statement stmt = connection.createStatement()) { return
	...
	private UserDetails mapRowWithUserDetails(ResultSet rs) throws SQLException {
		...
		User user = new User(rs.getLong("user_id"), rs.getString("full_name"), rs.getString("email"),
				rs.getString("phone"), rs.getString("role"), rs.getString("status"), rs.getTimestamp("created_at"),
