...
public class AdminKycDAO {
    ...
    public List<AdminKycDTO> getPendingKycs() {
        ...
        try (Connection con = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                dto.setMaskedPhone(maskPhone(rs.getString("phone")));
                ...
                dto.setSubmittedAt(rs.getTimestamp("updated_at").toLocalDateTime());
   ...
   public static void main(String[] args) {
	   AdminKycDAO ob=new AdminKycDAO();
	   System.out.println(ob.getPendingKycs());
}
    public void updateStatus(int kycId, String status, String remarks, String admin) {
